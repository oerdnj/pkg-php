...
/* $Id: aolserver.c,v 1.81.2.2 2006/01/01 12:50:18 sniper Exp $ */
...
static void php_info_aolserver(ZEND_MODULE_INFO_FUNC_ARGS)
{
	...
	php_info_print_table_row(2, "SAPI module version", "$Id: aolserver.c,v 1.81.2.2 2006/01/01 12:50:18 sniper Exp $");
